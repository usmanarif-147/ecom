<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Manage your store's categories.</p>
        </div>
    </div>
    ...
    <form wire:submit="save" class="flex gap-3">
        <input type="text" wire:model="title" placeholder="New category title"
    ...
    <div class="bg-white border border-gray-200 rounded-lg overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($categories as $category)
                    <tr class="hover:bg-gray-50">
                        ...
                        @else
                            ...
                            <td class="px-4 py-3 text-right space-x-3">
                                <button type="button" wire:click="startEdit({{ $category->id }})"
                                    class="text-gray-700 hover:text-gray-900 font-medium">
                                    Edit
                                </button>
                ...
                @empty
                    <tr>
                        <td colspan="3" class="px-4 py-10 text-center text-gray-500">No categories yet. Add one above.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
