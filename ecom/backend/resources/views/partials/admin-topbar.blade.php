<header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 md:px-8 sticky top-0 z-30">
    <h1 class="text-lg font-semibold text-gray-900">{{ $pageTitle ?? 'Admin' }}</h1>
    ...
    <div class="flex items-center space-x-4">
        ...
        <div class="flex items-center space-x-3">
            ...
            <div class="hidden sm:block leading-tight">
                ...
                <div class="text-xs text-gray-500">admin@myshop.com</div>
            </div>
        </div>
